...
uint8_t *aes_pkcs5padding(uint8_t *data, uint32_t data_len, uint32_t *out_len); 
uint8_t *aes_pkcs5unpadding(uint8_t *in, uint32_t len, uint32_t * out_len);

uint8_t *AES_ECB_Pkcs5Padding_Decrypt(uint8_t *data, uint32_t data_len, 
									  uint8_t *key,	uint32_t key_len, 
									  uint32_t *outLen);

uint8_t *AES_ECB_Pkcs5Padding_Encrypt(uint8_t *data, uint32_t data_len, 
									  uint8_t *key,	uint32_t key_len, 
									  uint32_t *outLen);
